...
class IntoOnboarding extends StatefulWidget {
  const IntoOnboarding({Key? key}) : super(key: key);

  @override
  State<IntoOnboarding> createState() => _IntoOnboardingState();
}

class _IntoOnboardingState extends State<IntoOnboarding> {
  @override
