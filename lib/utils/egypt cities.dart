class EgyptCities {
  static Map<String, Map<String, String>> citiesInEnglishAndArabic = {
    "Cairo": {
    ...
    "New Valley": {"El Kharga	": "	الخارجة", "New Valley	": "	الوادي الجديد"},
    "Port Said": {
      "Port Fouad	": "	بور فؤاد",
      "Port Said	": "	بورسعيد",
    ...
    "North Sinai": {"North Sinai	": "	شمال سيناء", "Al Arish	": "	العريش"},
    "South Sinai": {
      "Neweibaa	": "	نويبع",
      "Dahab	": "	دهب",
